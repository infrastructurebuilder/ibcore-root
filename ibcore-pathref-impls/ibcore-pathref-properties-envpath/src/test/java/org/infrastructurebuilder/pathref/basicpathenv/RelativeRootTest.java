...
import org.infrastructurebuilder.pathref.basicpathenv.BasicPathEnvPathRefSupplier;
...
class RelativeRootTest {
  ...
  private BasicPathEnvPathRefSupplier h;

  @BeforeEach
  void setUp() throws Exception {
    tps = new TestingPathSupplier();
    h = new BasicPathEnvPathRefSupplier(HOME); // Maybe doesn't test on windows
  ...
  void testBasicConstruct() {
    assertNotNull(new BasicPathEnvPathRefSupplier());
  }
