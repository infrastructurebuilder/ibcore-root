 ...
 */
@Named(SetValuePathRefProducer.NAME)
// NOT a singleton
public class SetValuePathRefProducer extends AbstractBasicPathPropertiesPathRefProducer {
  private static final Logger log = LoggerFactory.getLogger(SetValuePathRefProducer.class);
   ...
   */
  @Inject
  public SetValuePathRefProducer() {
  }
