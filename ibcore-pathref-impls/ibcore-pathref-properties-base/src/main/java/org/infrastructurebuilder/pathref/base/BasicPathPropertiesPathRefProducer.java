 ...
 */
@Singleton
@Named(BasicPathPropertiesPathRefProducer.NAME)
public class BasicPathPropertiesPathRefProducer extends AbstractBasicPathPropertiesPathRefProducer {

  static final Logger log = LoggerFactory.getLogger(BasicPathPropertiesPathRefProducer.class);
  public static final String RR_BASIC_PATH = "pathref.path";
