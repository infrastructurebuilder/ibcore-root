...
public class DefaultIBArtifactVersionMapper implements IBArtifactVersionMapper {
  ...
  @Inject
  public DefaultIBArtifactVersionMapper(LoggerSupplier l, Map<String, IBVersionsSupplier> ibvs) {
    this.log = Objects.requireNonNull(l, "Logger for DefaultIBArtifactVersionMapper").get();
