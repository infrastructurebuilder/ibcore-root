...
public class IBCredentialsException extends RuntimeException {
  ...
  public static ExceptionTranslator et = ET.newConfiguration().translate(Exception.class)
      .to(IBCredentialsException.class).done();

  public IBCredentialsException() {
  }

  public IBCredentialsException(final String message) {
    super(message);
  }

  public IBCredentialsException(final String message, final Throwable cause) {
    super(message, cause);
  }
