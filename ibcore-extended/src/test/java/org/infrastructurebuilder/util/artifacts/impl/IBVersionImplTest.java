...
import org.infrastructurebuilder.util.artifacts.impl.DefaultIBVersion.DefaultDeliver8rVersionRange;
...
public class IBVersionImplTest {
  ...
  public void statisfies_works_will_all_the_types() {
    ...
    final IBVersionRequirement req = DefaultIBVersion.DefaultDeliver8rVersionRequirement
        .buildLoose("1.2.3");
  ...
  public void testdeliver8rVersionRangeImpl() {
    final DefaultDeliver8rVersionRange testRange = new DefaultIBVersion.DefaultDeliver8rVersionRange(
