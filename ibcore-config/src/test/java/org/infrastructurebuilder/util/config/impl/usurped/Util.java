...
public class Util {
   ...
   */
  public static void compareActualVsExpectedJsonArrays(JSONArray jsonArray, JSONArray expectedJsonArray) {
   ...
   */
  public static void compareActualVsExpectedJsonObjects(JSONObject jsonObject, JSONObject expectedJsonObject) {
  ...
  private static void compareActualVsExpectedObjects(Object value, Object expectedValue) {
    if (value instanceof JSONObject && expectedValue instanceof JSONObject) {
      ...
      /**
       * Compare all other types using toString(). First, the types must also be equal, unless both are Number type.
       * Certain helper classes (e.g. XML) may create Long instead of Integer for small int values.
       */
