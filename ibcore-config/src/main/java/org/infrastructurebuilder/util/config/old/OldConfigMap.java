...
@Deprecated
public class OldConfigMap implements Map<String, Object> {
  private final Map<String, Object> config;

  public OldConfigMap(Map<String, Object> c) {
  ...
  public OldConfigMap(Properties p) {
    this.config = new HashMap<>();
    p.stringPropertyNames().forEach(k -> this.config.put(k, p.getProperty(k)));
  }

  public OldConfigMap(OldConfigMap configuration) {
    config = new HashMap<>();
