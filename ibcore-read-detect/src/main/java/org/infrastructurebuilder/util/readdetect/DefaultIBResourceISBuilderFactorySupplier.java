...
@Singleton
public class DefaultIBResourceISBuilderFactorySupplier extends AbstractIBResourceISBuilderFactorySupplier {
  public final static String NAME = "default";

  @Inject
  public DefaultIBResourceISBuilderFactorySupplier(RelativeRootFactory rrf) {
    super(rrf);
  }
