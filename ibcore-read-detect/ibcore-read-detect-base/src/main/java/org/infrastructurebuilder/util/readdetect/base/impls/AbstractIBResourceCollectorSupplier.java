...
abstract public class AbstractIBResourceCollectorSupplier<I>
    implements IBResourceCollectorSupplier, ConfigMapConfigurable {
  ...
  public IBResourceCollectorSupplier withConfig(ConfigMap config) {
    ...
    if (_cdir.startsWith(PathRefPathIF.PATHREFPREFIX))
      ...
      this.cacheDirectory.compareAndSet(null, PathRefPathIF.getOrCreatePRFS(this.pathSuppliers.get(_cdir).get(), cfg) //
