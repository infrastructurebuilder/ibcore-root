...
public class AbsolutePathIBResourceBuilderFactory extends AbstractPathIBResourceBuilderFactory {
  ...
  public class AbsolutePathIBResourceBuilder extends AbstractPathIBResourceBuilder {
    ...
    public boolean acceptable(String p) {
      return ofNullable(p).map(Paths::get).map(Path::isAbsolute).orElse(false);
    }
    ...
    public static class AbsolutePathIBResource extends AbstractIBResource {
      ...
      private AbsolutePathIBResource(IBResourceModel m, PathAndChecksum p) {
        super(m, p);
