 ...
 * @formatter:on
 */
package org.infrastructurebuilder.util.readdetect.path;
...
import org.infrastructurebuilder.util.readdetect.path.impls.absolute.AbsolutePathIBResource;
...
public class ThrowingIBChecksumType extends AbsolutePathIBResource {
  ...
  public OptStream get() {
    return new OptStream(new ThrowingInputStream(IOException.class));
  }
